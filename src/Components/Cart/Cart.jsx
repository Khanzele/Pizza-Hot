...
import { deletePizzas, orderPizza } from '../../Redux/Slices/cart/cartSlice.js';
      ...
      {pizzas.length >= 1 ? (
        <div className="CartHeader">
          <div className="CartTitle">
            <img src="https://cdn-icons-png.flaticon.com/512/711/711897.png" alt='' />
            <h2>Корзина</h2>
          </div>
          <div className="CartBtnClean">
            ...
            >
              <img src="https://i.ibb.co/y6jFMLx/bin.png" alt='' />
              Очистить корзину
            </button>
          </div>
        </div>
      ...
      {pizzas.length >= 1 ? (
        <div className="CartFooter">
          ...
          <div className="CartForm">
            ...
            >
              <img src="https://i.ibb.co/qY0LRB5/left-arrow.png" alt="" />
              Вернуться назад
            </button>
            <button
              onClick={() => {
